...
if($del!="")
{
  echo $delsql="delete from training where id=$del";
...
if(isset($_POST['delete']))
{
  ...
  {
   $d=$_POST['delid'][$a];
   $delsql="delete from training where id=$d";
   mysqli_query($conn,$delsql);
   $a++;
  }
}
...
<html>
 ...
 <body>  
    ...
    <div class="main">
      ...
      <div class="pagetitle">  Training Enquiry </div>
      ...
      <div class="mright2" style="height:600px;">
        ...
        <form method="post">
           ...
           <div class="viewrow" style="margin-top:20px;">
              ...
              <div class="viewcol2 w150"> <?php echo $row['contact']?> </div>   
              <div class="viewcol2 w200"><?php echo $row['email']?> </div>
              <div class="viewcol2 w200"><?php echo $row['course']?> </div>  
           </div>      
           <?php
            }
           ?> 
